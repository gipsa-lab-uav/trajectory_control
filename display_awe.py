...
class Display:
    ...
    def trajectoryCallback(self, trajectory):
        ...
        self.r_desired = np.append(self.r_desired, position[0])[-self.window_10:]
        self.b_desired = np.append(self.b_desired, position[1])[-self.window_10:]
    ...
    def start(self):
        ...
        ax4.set_ylim(-5, 5)
        line8, = ax4.plot(self.x_10, self.r_desired, 'r--')
        line9, = ax4.plot(self.x_10, self.b_desired, 'g--')
